...
namespace adk {
	/**
	 * @brief Represents a Milk Bucket Item
	 */
	class ItemMilkBucket : public Item {
	public:
		/**
		 * @brief Construct a new Milk Bucket Item object
		 *
		 * @param property ItemProperty
		 */
		ItemMilkBucket(ItemProperty property) { internal_ = property; }
